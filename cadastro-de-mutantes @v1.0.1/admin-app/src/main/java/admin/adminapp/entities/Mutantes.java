...
public class Mutantes implements Serializable{
    ...
    public Mutantes(Long id_mutante, String pais, String uf, 
    				String cidade, String nome, String habilidade, Administrator id_Admin) {
    ...
    public void setIdmutante(Long id_mutante) {
        this.id_mutante = id_mutante;
    }
